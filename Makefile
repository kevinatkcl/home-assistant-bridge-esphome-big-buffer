...
# ha_discovery_data.h is now generated by generate_erd_lists.py (in-process),
# so it's produced as a side effect of the erd_lists.h rule.
HA_DISCOVERY_DATA_HEADER := components/geappliances_bridge/ha_discovery_data.h

$(HA_DISCOVERY_DATA_HEADER): $(ERD_LISTS_HEADER)
	@# ha_discovery_data.h is generated as a side effect of the erd_lists.h rule
