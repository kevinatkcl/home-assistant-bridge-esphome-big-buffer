...
#define APPLIANCE_TYPE_MAP_H

#include <cstdint>
#include <string>

inline std::string appliance_type_to_string(uint8_t appliance_type) {
  switch (appliance_type) {
    ...
    case 32: return "FAndPDishDrawer";
    ...
    case 39: return "FisherAndPaykelCooktop";
    case 40: return "FAndPCooktopTeppanyaki";
    case 41: return "FAndPVentilationDowndraft";
