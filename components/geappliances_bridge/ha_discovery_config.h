...
// MODULE GOAL
// =============================================================================
// Goal: Enumerate the ERD IDs whose values are null-terminated ASCII strings
//       so the MQTT adapter can publish them as text rather than hex.
//
// Responsibilities:
//   - Declare ha_string_erd_ids[] and ha_string_erd_count at file scope
//
// NOT responsible for:
//   - HA entity configuration (fetched at runtime from JSONL files)
//   - ERD validity filtering
//   - Any logic — data declarations only
//
// Note: The ERD list below is generated. Do not edit manually.
